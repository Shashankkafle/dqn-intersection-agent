...
class UniversalTrafficGenerator:
    ...
    def _generate_trips(self, net):
        ...
        tripIDs = random.choices(self._ROUTE_IDS, weights=weights, k=int((self._sim_end-self._sim_start) * self._vehicle_rate))
    ...
    def generate_route_file(self):
        ...
        trips = self._generate_trips(net)

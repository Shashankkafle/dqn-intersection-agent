...
class TrainModel:
    ...
    def _build_model(self, num_layers, width):
        ...
        # FIX: Use string for loss and 'learning_rate' instead of 'lr'
        model.compile(loss='mean_squared_error', optimizer=Adam(learning_rate=self._learning_rate))
        return model
    
    def _build_model_with_cnn(self, input_dim):
        """
